...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  // CEP
  CEP_VENDEDOR: "Ex: 89.214-700",
  CEP_COMPRADOR: "Ex: 89.214-700",
  CEP_LOCADOR: "Ex: 89.214-700",
  CEP_LOCATARIO: "Ex: 89.214-700",
  CEP_COMODANTE: "Ex: 89.214-700",
  CEP_COMODATARIO: "Ex: 89.214-700",
  CEP_CONTRATANTE: "Ex: 89.214-700",
  CEP_CONTRATADO: "Ex: 89.214-700",
  CEP_TERRENO: "Ex: 89.214-700",

  // Cidade/Estado
  CIDADE_VENDEDOR: "Ex: Joinville",
  CIDADE_COMPRADOR: "Ex: Joinville",
  CIDADE_LOCADOR: "Ex: Joinville",
  CIDADE_LOCATARIO: "Ex: Joinville",
  CIDADE_COMODANTE: "Ex: Joinville",
  CIDADE_COMODATARIO: "Ex: Joinville",
  CIDADE_TERRENO: "Ex: Joinville",
  CIDADE_IMOVEL: "Ex: Joinville",
  CIDADE_FORO: "Ex: Joinville",
  CIDADE_EMISSAO: "Ex: Joinville (cidade onde o contrato é assinado)",
  ESTADO_VENDEDOR: "Ex: SC",
  ESTADO_COMPRADOR: "Ex: SC",
  ESTADO_LOCADOR: "Ex: SC",
  ESTADO_LOCATARIO: "Ex: SC",
  ESTADO_COMODANTE: "Ex: SC",
  ESTADO_COMODATARIO: "Ex: SC",
  ESTADO_TERRENO: "Ex: SC",
  ESTADO_IMOVEL: "Ex: SC",
  ESTADO_FORO: "Ex: SC",
